// output maximal clique intersection graph. If the number of overlap vertices is above the threshold, draw a edge between two points
#include <fstream>
#include <iostream>
#include <cstdlib>
#include <vector>
...
int nodes_t;    // the threshold of common nodes between maximal cliques
